...
export default function(req, res) {
  ...
  "continents": [
    ...
    {
      "name": "América do Sul",
      "description": "A América do Sul tem doze países. Países que apesar de compartilharem palavras, comidas e costumes têm suas características bem marcadas e um povo que lida com dificuldades diárias, mas nunca deixa de caminhar.",
    ...
    {
      "name": "Ásia",
      "description": "A Ásia é o maior continente em área terrestre do mundo, estando boa parte do continente localizado no Hemisfério Norte. Além de ser o mais extenso, é também o mais populoso, habitando nele cerca de três quintos da população mundial.",
    ...
    {
      "name": "África",
      "description": "O continente africano possui uma das maiores diversidades culturais do planeta. Na chamada África Branca, ao norte, predominam os povos caucasóides e semitas e na chamada África Negra, ao sul do Deserto do Saara, encontram-se os povos pigmeus, bosquímanos, hotentotes, sudaneses e os bantos.",
    ...
    {
      "name": "Oceânia",
      "description": "A Oceania é um continente que caracteriza-se pela grande presença de ilhas. O nome Oceania é uma referência ao oceano Pacífico, que é a principal referência de unidade da região.",
